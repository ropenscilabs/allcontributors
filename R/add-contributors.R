...
contribs_to_readme <- function (dat, orgrepo, ncols, format, filename) {
    ...
    xmid <- c (xmid,
               ...
               paste0 ("This project uses the ",
                       "[`allcontributors` package](https://github.com/mpadge/allcontributors)",
                       " following the ",
...
open_allcontribs_issue <- function (org, repo, ctbs) {
    ...
    if (!"all contributors" %in% tolower (x$title)) {
        ...
        b <- paste0 ("Hi All! This repository uses the ",
                     ...
                     "\u0028https://github.com/mpadge/allcontributors\u0029 ",
                     ...
                     "\u0028https://mpadge.github.io/allcontributors/reference/add_contributors.html\u0029",
